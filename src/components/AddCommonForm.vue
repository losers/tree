<template>
  <div class="FormData p-5 glass-card-form">
    <h3 class="mb-3" style="color: #4f8ef7; font-weight: bold;">
      {{ payload.memData ? "Edit" : "Add" }} Member
    </h3>
    <form v-on:submit.prevent="sendData">
      <div class="row">
        <label class="d-none d-sm-block col-md-4" style="color: rgba(255,255,255,0.8)">
          <span class="text-warning mr-1">*</span>Name :
        </label>
        <input
          type="text"
          class="form-control col-md-7 col-sm-12 dark-input"
          v-model="data.name"
      ...
      <div class="row" v-else>
        <div class="form-check col-3 ml-3">
          <input
            ...
            required
          />
          <label for="male" class="form-check-label ml-2" style="color: rgba(255,255,255,0.8)"
            >Male</label
          >
        </div>
        <div class="form-check">
          <input
            ...
            value="0"
          />
          <label for="female" class="form-check-label ml-2" style="color: rgba(255,255,255,0.8)"
            >Female</label
          >
        </div>
      </div>
      ...
      >
        <hr class="mt-5" style="background-color: rgba(255,255,255,0.2)" />
        <center style="margin-top: -29px">
          <span class="optional-heading"> Optional Details </span>
        </center>
        <div class="row mt-4">
          <label class="d-none d-sm-block col-md-4" style="color: rgba(255,255,255,0.8)">Short Name:</label>
          <input
            type="text"
            class="form-control col-md-7 col-sm-12 dark-input"
        ...
        <div class="row" v-if="xtraParent.show">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">
          ...
          <vSelect
            ...
            class="col-md-7 col-sm-12 myselect dark-vselect"
          ></vSelect>
        </div>
        <div class="row">
          <label class="col-md-4 d-none d-sm-flex flexy" style="color: rgba(255,255,255,0.8)">DOB :</label>
          <md-datepicker
            class="col-md-7 col-xs-12 cus dark-datepicker"
            v-model="data.dob"
            :md-model-type="String"
          >
            <label style="color: rgba(255,255,255,0.5)">Date of Birth</label>
          </md-datepicker>
        </div>

        <div class="row mb-2">
          <label class="col-4 flexy" style="color: rgba(255,255,255,0.8)">Is Alive :</label>
          <toggle-button
            v-model="is_alive"
            :value="is_alive"
            :sync="true"
          ...
          <div class="form-inline col-md-6 col-xs-12" v-show="!is_alive">
            <md-datepicker
              ...
              required="true"
              class="cus dark-datepicker"
              id="demise"
              :md-model-type="String"
            >
              <label style="color: rgba(255,255,255,0.5)">Date of Demise</label>
            </md-datepicker>
          </div>
        </div>

        <div class="row">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">Mobile :</label>
          <input
            type="tel"
            class="form-control col-md-7 col-sm-12 dark-input"
            v-model="data.mobile"
        ...
        <div class="row">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">Email :</label>
          <input
            type="email"
            class="form-control col-md-7 col-sm-12 dark-input"
            v-model="data.email"
        ...
        <div class="row">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">Address :</label>
          <input
            type="text"
            class="form-control col-md-7 col-sm-12 dark-input"
        ...
        <div class="row">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">Country :</label>
          <vSelect
            :options="countries"
            placeholder="Select Country"
            v-model="data.country"
            class="mb-3 col-md-7 col-sm-12 p-0 dark-vselect"
          ></vSelect>
        </div>

        <!-- Description -->
        <div class="row">
          <label class="d-none d-sm-flex col-md-4" style="color: rgba(255,255,255,0.8)">Description :</label>
          <textarea
            class="form-control col-md-7 col-sm-12 dark-input"
            rows="3"
        ...
        <hr class="mt-5 mb-3" style="background-color: rgba(255,255,255,0.2)" />
        <p style="margin-top: -29px">
          <center>
            <span style="background-color: #0f1123; padding: 20px; color: #a78bfa"
              >Social Media</span
            >
          </center>
        </p>
        ...
        <div class="md-form input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text md-addon dark-addon">
              <i class="icofont-facebook"></i>
            </span>
          </div>
          <input
            type="url"
            class="form-control rounded-0 dark-input"
            v-model="data.fb"
