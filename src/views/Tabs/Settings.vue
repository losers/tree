<template>
  <div>
    ...
    <section v-else>
      ...
      <!-- Settings Body -->
      <div v-else :style="{ padding: $device.mobile ? '0 50px 50px 50px' : '0 200px' }">
        <p style="float: right">
        ...
        <form v-on:submit.prevent="updateSettings">
          ...
          <div v-if="data.pin == '1234' || data.pin == '0000'" class="mt-3 text-warning">
          ...
          <div v-if="data.view_pin == data.pin && data.pin" class="mt-3 text-danger">
        ...
        <div class="danger-zone">
          ...
          <input class="form-control input-lg" type="text" v-model="deleteSurname" />
          <button
        ...
        <div class="mt-5">
          Any Trouble ?
          <a href="mailto:bloodline.helpline@gmail.com">bloodline.helpline@gmail.com</a>
        </div>
      </div>
    </section>
  </div>
